                ...
                <div class="mods-result-body">
                    <div class="mods-result-head">
                        ...
                        <div class="mods-result-actions">
                            <button class="mods-install-btn ${installedMatch ? 'mods-install-btn--installed' : ''}" type="button" data-install-mod="${escapeHtml(mod.id)}" ${installDisabled}>${escapeHtml(installLabel)}</button>
                            ${quickActions}
                        </div>
                    </div>
